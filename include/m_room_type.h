...
enum {
    ...
    mRmTp_LIGHT_SWITCH_HOUSE4_MAIN_UPPER, /* multiplayer fork: eight houses */
    mRmTp_LIGHT_SWITCH_HOUSE4_BASEMENT,
    mRmTp_LIGHT_SWITCH_HOUSE5_MAIN_UPPER,
    mRmTp_LIGHT_SWITCH_HOUSE5_BASEMENT,
    mRmTp_LIGHT_SWITCH_HOUSE6_MAIN_UPPER,
    mRmTp_LIGHT_SWITCH_HOUSE6_BASEMENT,
    mRmTp_LIGHT_SWITCH_HOUSE7_MAIN_UPPER,
    mRmTp_LIGHT_SWITCH_HOUSE7_BASEMENT,
