...
s16 props_profile_table[] = {
    ...
    /* the second house acre (multiplayer fork): MAILBOX4..7, HANIWA4..7 */
    mAc_PROFILE_MAILBOX,  mAc_PROFILE_MAILBOX,  mAc_PROFILE_MAILBOX,   mAc_PROFILE_MAILBOX,
    mAc_PROFILE_HANIWA,   mAc_PROFILE_HANIWA,   mAc_PROFILE_HANIWA,    mAc_PROFILE_HANIWA,
};
