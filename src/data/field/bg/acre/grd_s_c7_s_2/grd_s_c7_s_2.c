...
#ifdef TARGET_PC
static Vtx grd_s_c7_s_2_v[0xC80 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_field_bg_acre_grd_s_c7_s_2_grd_s_c7_s_2_c(void) {
    pc_load_asset("assets/field/bg/grd_s_c7_s_2_v.bin", grd_s_c7_s_2_v, 0xC80, 0x9CB778, 0, 2);
}
#endif
