...
#ifdef TARGET_PC
static Vtx grd_s_o_5_v[0x340 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_field_bg_acre_grd_s_o_5_grd_s_o_5_c(void) {
    pc_load_asset("assets/field/bg/grd_s_o_5_v.bin", grd_s_o_5_v, 0x340, 0xA13E50, 0, 2);
}
#endif
