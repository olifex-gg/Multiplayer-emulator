...
#ifdef TARGET_PC
static Vtx grd_s_o_7_v[0x350 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_field_bg_acre_grd_s_o_7_grd_s_o_7_c(void) {
    pc_load_asset("assets/field/bg/grd_s_o_7_v.bin", grd_s_o_7_v, 0x350, 0xA147B8, 0, 2);
}
#endif
