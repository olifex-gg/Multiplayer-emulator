...
#ifdef TARGET_PC
static Vtx grd_s_t_r1_5_v[0x1160 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_field_bg_acre_grd_s_t_r1_5_grd_s_t_r1_5_c(void) {
    pc_load_asset("assets/field/bg/grd_s_t_r1_5_v.bin", grd_s_t_r1_5_v, 0x1160, 0xA5F3C8, 0, 2);
}
#endif
