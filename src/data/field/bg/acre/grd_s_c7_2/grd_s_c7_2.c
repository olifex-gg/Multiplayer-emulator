...
#ifdef TARGET_PC
static Vtx grd_s_c7_2_v[0x1110 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_field_bg_acre_grd_s_c7_2_grd_s_c7_2_c(void) {
    pc_load_asset("assets/field/bg/grd_s_c7_2_v.bin", grd_s_c7_2_v, 0x1110, 0x9C2B08, 0, 2);
}
#endif
