...
#ifdef TARGET_PC
static Vtx grd_s_f_8_v[0xD20 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_field_bg_acre_grd_s_f_8_grd_s_f_8_c(void) {
    pc_load_asset("assets/field/bg/grd_s_f_8_v.bin", grd_s_f_8_v, 0xD20, 0x9DC480, 0, 2);
}
#endif
