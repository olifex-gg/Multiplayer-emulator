...
#ifdef TARGET_PC
static Vtx grd_s_r4_2_v[0xD10 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_field_bg_acre_grd_s_r4_2_grd_s_r4_2_c(void) {
    pc_load_asset("assets/field/bg/grd_s_r4_2_v.bin", grd_s_r4_2_v, 0xD10, 0xA355A8, 0, 2);
}
#endif
