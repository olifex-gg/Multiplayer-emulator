...
#ifdef TARGET_PC
static Vtx grd_s_r3_p_1_v[0x1370 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_field_bg_acre_grd_s_r3_p_1_grd_s_r3_p_1_c(void) {
    pc_load_asset("assets/field/bg/grd_s_r3_p_1_v.bin", grd_s_r3_p_1_v, 0x1370, 0xA32FC0, 0, 2);
}
#endif
