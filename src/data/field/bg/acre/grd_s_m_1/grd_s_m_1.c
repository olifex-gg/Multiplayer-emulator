...
#ifdef TARGET_PC
static Vtx grd_s_m_1_v[0xE00 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_field_bg_acre_grd_s_m_1_grd_s_m_1_c(void) {
    pc_load_asset("assets/field/bg/grd_s_m_1_v.bin", grd_s_m_1_v, 0xE00, 0x9F4F98, 0, 2);
}
#endif
