...
#ifdef TARGET_PC
static Vtx grd_s_t_5_v[0xF80 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_field_bg_acre_grd_s_t_5_grd_s_t_5_c(void) {
    pc_load_asset("assets/field/bg/grd_s_t_5_v.bin", grd_s_t_5_v, 0xF80, 0xA52340, 0, 2);
}
#endif
