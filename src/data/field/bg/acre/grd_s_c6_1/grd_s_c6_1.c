...
#ifdef TARGET_PC
static Vtx grd_s_c6_1_v[0xED0 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_field_bg_acre_grd_s_c6_1_grd_s_c6_1_c(void) {
    pc_load_asset("assets/field/bg/grd_s_c6_1_v.bin", grd_s_c6_1_v, 0xED0, 0x9B9908, 0, 2);
}
#endif
