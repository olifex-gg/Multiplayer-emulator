...
#ifdef TARGET_PC
static Vtx grd_s_m_8_v[0xD10 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_field_bg_acre_grd_s_m_8_grd_s_m_8_c(void) {
    pc_load_asset("assets/field/bg/grd_s_m_8_v.bin", grd_s_m_8_v, 0xD10, 0x9FDDA0, 0, 2);
}
#endif
