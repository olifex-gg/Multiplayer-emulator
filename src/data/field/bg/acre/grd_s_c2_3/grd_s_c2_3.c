...
#ifdef TARGET_PC
static Vtx grd_s_c2_3_v[0x1080 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_field_bg_acre_grd_s_c2_3_grd_s_c2_3_c(void) {
    pc_load_asset("assets/field/bg/grd_s_c2_3_v.bin", grd_s_c2_3_v, 0x1080, 0x98E070, 0, 2);
}
#endif
