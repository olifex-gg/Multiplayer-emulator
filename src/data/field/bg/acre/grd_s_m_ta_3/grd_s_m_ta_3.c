...
#ifdef TARGET_PC
static Vtx grd_s_m_ta_3_v[0xF70 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_field_bg_acre_grd_s_m_ta_3_grd_s_m_ta_3_c(void) {
    pc_load_asset("assets/field/bg/grd_s_m_ta_3_v.bin", grd_s_m_ta_3_v, 0xF70, 0xA0C760, 0, 2);
}
#endif
