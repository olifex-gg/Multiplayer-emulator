...
#ifdef TARGET_PC
static Vtx grd_s_r2_b_3_v[0x11B0 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_field_bg_acre_grd_s_r2_b_3_grd_s_r2_b_3_c(void) {
    pc_load_asset("assets/field/bg/grd_s_r2_b_3_v.bin", grd_s_r2_b_3_v, 0x11B0, 0xA289B8, 0, 2);
}
#endif
