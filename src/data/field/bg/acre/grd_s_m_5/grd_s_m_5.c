...
#ifdef TARGET_PC
static Vtx grd_s_m_5_v[0x1000 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_field_bg_acre_grd_s_m_5_grd_s_m_5_c(void) {
    pc_load_asset("assets/field/bg/grd_s_m_5_v.bin", grd_s_m_5_v, 0x1000, 0x9FA6E0, 0, 2);
}
#endif
