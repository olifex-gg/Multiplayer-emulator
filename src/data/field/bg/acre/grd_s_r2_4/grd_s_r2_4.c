...
#ifdef TARGET_PC
static Vtx grd_s_r2_4_v[0xD50 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_field_bg_acre_grd_s_r2_4_grd_s_r2_4_c(void) {
    pc_load_asset("assets/field/bg/grd_s_r2_4_v.bin", grd_s_r2_4_v, 0xD50, 0xA24FF8, 0, 2);
}
#endif
