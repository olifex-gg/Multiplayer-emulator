...
#ifdef TARGET_PC
static Vtx grd_s_c6_3_v[0xD60 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_field_bg_acre_grd_s_c6_3_grd_s_c6_3_c(void) {
    pc_load_asset("assets/field/bg/grd_s_c6_3_v.bin", grd_s_c6_3_v, 0xD60, 0x9BBC40, 0, 2);
}
#endif
