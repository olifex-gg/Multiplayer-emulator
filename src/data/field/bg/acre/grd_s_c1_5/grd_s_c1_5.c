...
#ifdef TARGET_PC
static Vtx grd_s_c1_5_v[0xCD0 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_field_bg_acre_grd_s_c1_5_grd_s_c1_5_c(void) {
    pc_load_asset("assets/field/bg/grd_s_c1_5_v.bin", grd_s_c1_5_v, 0xCD0, 0x97B6A8, 0, 2);
}
#endif
