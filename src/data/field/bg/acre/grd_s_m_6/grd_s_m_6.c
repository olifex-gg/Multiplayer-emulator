...
#ifdef TARGET_PC
static Vtx grd_s_m_6_v[0xF70 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_field_bg_acre_grd_s_m_6_grd_s_m_6_c(void) {
    pc_load_asset("assets/field/bg/grd_s_m_6_v.bin", grd_s_m_6_v, 0xF70, 0x9FBAB0, 0, 2);
}
#endif
