...
#ifdef TARGET_PC
static Vtx grd_s_f_9_v[0xF70 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_field_bg_acre_grd_s_f_9_grd_s_f_9_c(void) {
    pc_load_asset("assets/field/bg/grd_s_f_9_v.bin", grd_s_f_9_v, 0xF70, 0x9DD3A8, 0, 2);
}
#endif
