...
#ifdef TARGET_PC
static Vtx grd_s_t_10_v[0xE30 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_field_bg_acre_grd_s_t_10_grd_s_t_10_c(void) {
    pc_load_asset("assets/field/bg/grd_s_t_10_v.bin", grd_s_t_10_v, 0xE30, 0xA4E698, 0, 2);
}
#endif
