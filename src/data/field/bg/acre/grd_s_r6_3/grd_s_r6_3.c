...
#ifdef TARGET_PC
static Vtx grd_s_r6_3_v[0xB10 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_field_bg_acre_grd_s_r6_3_grd_s_r6_3_c(void) {
    pc_load_asset("assets/field/bg/grd_s_r6_3_v.bin", grd_s_r6_3_v, 0xB10, 0xA42E38, 0, 2);
}
#endif
