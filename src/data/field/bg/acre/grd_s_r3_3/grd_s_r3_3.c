...
#ifdef TARGET_PC
static Vtx grd_s_r3_3_v[0xC90 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_field_bg_acre_grd_s_r3_3_grd_s_r3_3_c(void) {
    pc_load_asset("assets/field/bg/grd_s_r3_3_v.bin", grd_s_r3_3_v, 0xC90, 0xA2D6C8, 0, 2);
}
#endif
