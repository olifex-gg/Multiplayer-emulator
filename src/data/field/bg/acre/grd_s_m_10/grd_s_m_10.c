...
#ifdef TARGET_PC
static Vtx grd_s_m_10_v[0xDF0 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_field_bg_acre_grd_s_m_10_grd_s_m_10_c(void) {
    pc_load_asset("assets/field/bg/grd_s_m_10_v.bin", grd_s_m_10_v, 0xDF0, 0x9F60F0, 0, 2);
}
#endif
