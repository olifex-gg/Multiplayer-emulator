...
#ifdef TARGET_PC
u16 int_sum_asi_taiko_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u8 int_sum_asi_taiko_side_tex[0x100];
#else
...
#ifdef TARGET_PC
u8 int_sum_asi_taiko_top_tex[0x100];
#else
...
#ifdef TARGET_PC
u8 int_sum_asi_taiko_bese_tex[0x100];
#else
...
#ifdef TARGET_PC
Vtx int_sum_asi_taiko_v[0x2F0 / sizeof(Vtx)];
#else
