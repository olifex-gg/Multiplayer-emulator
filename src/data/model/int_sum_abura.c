...
#ifdef TARGET_PC
u16 int_sum_abura_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u16 int_sum_abura_hand_pic_ci4_pal[0x20 / sizeof(u16)];
#else
...
#ifdef TARGET_PC
u8 int_sum_abura_body_txt[0x200];
#else
...
#ifdef TARGET_PC
u8 int_sum_abura_side_txt[0x200];
#else
...
#ifdef TARGET_PC
u8 int_sum_abura_base_txt[0x80];
#else
...
#ifdef TARGET_PC
u8 int_sum_abura_top_txt[0x200];
#else
...
#ifdef TARGET_PC
u8 int_sum_abura_hand_txt[0x100];
#else
...
#ifdef TARGET_PC
Vtx int_sum_abura_v[0x470 / sizeof(Vtx)];
#else
Vtx int_sum_abura_v[] = {
