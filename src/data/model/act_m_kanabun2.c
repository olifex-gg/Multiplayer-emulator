...
#ifdef TARGET_PC
static u16 act_m_kanabun_pal[0x20 / sizeof(u16)];
#else
...
void _pc_load_src_data_model_act_m_kanabun2_c(void) {
    pc_load_asset("assets/act_m_kanabun2/act_m_kanabun_v.bin", act_m_kanabun_v, 0xC0, 0xB4DFA8, 0, 2);
    pc_load_asset("assets/act_m_kanabun2/act_m_kanabun_pal.bin", act_m_kanabun_pal, 0x20, 0xB4E068, 0, 1);
    pc_load_asset("assets/act_m_kanabun2/act_m_kanabun.bin", act_m_kanabun, 0x200, 0xB4E088, 0, 0);
}
#endif
