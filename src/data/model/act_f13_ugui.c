...
#ifdef TARGET_PC
u16 act_f13_ugui_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u8 act_f13_ugui_tex[0x300] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
Vtx act_f13_ugui_a_v[0x90 / sizeof(Vtx)];
#else
...
#ifdef TARGET_PC
Vtx act_f13_ugui_b_v[0x90 / sizeof(Vtx)];
#else
...
#ifdef TARGET_PC
Vtx act_f13_ugui_c_v[0x90 / sizeof(Vtx)];
#else
