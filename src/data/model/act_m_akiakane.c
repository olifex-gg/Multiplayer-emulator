...
void _pc_load_src_data_model_act_m_akiakane_c(void) {
    pc_load_asset("assets/act_m_akiakane/act_m_akiakane_pal.bin", act_m_akiakane_pal, 0x20, 0x53F8A0, 0, 1);
    pc_load_asset("assets/act_m_akiakane/act_m_akiakane.bin", act_m_akiakane, 0x180, 0x53F8C0, 0, 0);
    pc_load_asset("assets/act_m_akiakane/act_m_akiakane_v.bin", act_m_akiakane_v, 0x120, 0x53FA40, 0, 2);
}
#endif
