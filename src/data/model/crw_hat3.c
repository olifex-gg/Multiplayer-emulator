...
#ifdef TARGET_PC
u16 crw_hat3_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
Vtx crw_hat3_v[0x250 / sizeof(Vtx)];
#else
Vtx crw_hat3_v[] = {
