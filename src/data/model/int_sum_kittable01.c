...
#ifdef TARGET_PC
u16 int_sum_kittable01_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u8 int_sum_kittable01_side_tex[0x80];
#else
...
#ifdef TARGET_PC
u8 int_sum_kittable01_top_tex[0x200];
#else
...
#ifdef TARGET_PC
u8 int_sum_kittable01_draw_tex[0x80];
#else
...
#ifdef TARGET_PC
u8 int_sum_kittable01_foot_tex[0x180];
#else
...
#ifdef TARGET_PC
Vtx int_sum_kittable01_v[0x320 / sizeof(Vtx)];
#else
