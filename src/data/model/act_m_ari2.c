...
#ifdef TARGET_PC
static u16 act_m_ari_pal[0x20 / sizeof(u16)];
#else
...
void _pc_load_src_data_model_act_m_ari2_c(void) {
    pc_load_asset("assets/act_m_ari2/act_m_ari_v.bin", act_m_ari_v, 0x60, 0xB49C18, 0, 2);
    pc_load_asset("assets/act_m_ari2/act_m_ari_pal.bin", act_m_ari_pal, 0x20, 0xB49C78, 0, 1);
    pc_load_asset("assets/act_m_ari2/act_m_ari_tex.bin", act_m_ari_tex, 0x100, 0xB49C98, 0, 0);
}
#endif
