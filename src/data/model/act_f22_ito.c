...
#ifdef TARGET_PC
u16 act_f22_ito_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u8 act_f22_ito_tex[0x400] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
Vtx act_f22_ito_a_v[0x90 / sizeof(Vtx)];
#else
Vtx act_f22_ito_a_v[] = {
...
#ifdef TARGET_PC
Vtx act_f22_ito_b_v[0x90 / sizeof(Vtx)];
#else
Vtx act_f22_ito_b_v[] = {
...
#ifdef TARGET_PC
Vtx act_f22_ito_c_v[0x90 / sizeof(Vtx)];
#else
Vtx act_f22_ito_c_v[] = {
