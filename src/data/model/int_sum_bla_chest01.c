...
#ifdef TARGET_PC
u16 int_sum_bla_chest01_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u8 int_sum_bla_chest01_top_tex_txt[0x80];
#else
...
#ifdef TARGET_PC
u8 int_sum_bla_chest01_hiki_tex_txt[0x100];
#else
...
#ifdef TARGET_PC
u8 int_sum_bla_chest01_side_tex_txt[0x300];
#else
...
#ifdef TARGET_PC
u8 int_sum_bla_chest01_front_tex_txt[0x180];
#else
...
#ifdef TARGET_PC
Vtx int_sum_bla_chest01_v[0x2C0 / sizeof(Vtx)];
#else
