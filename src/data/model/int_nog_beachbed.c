...
#ifdef TARGET_PC
u16 int_nog_beachbed_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u8 int_nog_beachbed_body_tex[0x400];
#else
...
#ifdef TARGET_PC
u8 int_nog_beachbed_side_tex[0x200];
#else
...
#ifdef TARGET_PC
Vtx int_nog_beachbed_v[0x340 / sizeof(Vtx)];
#else
