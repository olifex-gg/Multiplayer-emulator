...
#ifdef TARGET_PC
u16 int_iku_cocoa_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u8 int_iku_cocoa_c_tex_txt[0x400];
#else
...
#ifdef TARGET_PC
u8 int_iku_cocoa_b_tex_txt[0x200];
#else
...
#ifdef TARGET_PC
u8 int_iku_cocoa_a_tex_txt[0x200];
#else
...
#ifdef TARGET_PC
Vtx int_iku_cocoa_v[0x310 / sizeof(Vtx)];
#else
Vtx int_iku_cocoa_v[] = {
