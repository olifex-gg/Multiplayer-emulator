...
#ifdef TARGET_PC
u16 act_f26_aroana_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u8 act_f26_aroana_tex[0x300] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
Vtx act_f26_aroana_a_v[0x90 / sizeof(Vtx)];
#else
...
#ifdef TARGET_PC
Vtx act_f26_aroana_b_v[0x90 / sizeof(Vtx)];
#else
...
#ifdef TARGET_PC
Vtx act_f26_aroana_c_v[0x90 / sizeof(Vtx)];
#else
