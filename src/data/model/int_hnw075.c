...
#ifdef TARGET_PC
u16 int_hnw075_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u8 int_hnw075_arm_tex_txt[0x100];
#else
...
#ifdef TARGET_PC
u8 int_hnw075_armtop_tex_txt[0x80];
#else
...
#ifdef TARGET_PC
u8 int_hnw075_c_front_tex_txt[0x300];
#else
...
#ifdef TARGET_PC
u8 int_hnw075_c_back_tex_txt[0x180];
#else
...
#ifdef TARGET_PC
u8 int_hnw075_b_back_tex_txt[0x80];
#else
...
#ifdef TARGET_PC
u8 int_hnw075_b_front_tex_txt[0x100];
#else
...
#ifdef TARGET_PC
Vtx int_hnw075_v[0x470 / sizeof(Vtx)];
#else
Vtx int_hnw075_v[] = {
