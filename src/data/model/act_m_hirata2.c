...
#ifdef TARGET_PC
static u16 act_m_hirata_pal[0x20 / sizeof(u16)];
#else
...
void _pc_load_src_data_model_act_m_hirata2_c(void) {
    pc_load_asset("assets/act_m_hirata2/act_m_hirata_v.bin", act_m_hirata_v, 0xC0, 0xB4C1A8, 0, 2);
    pc_load_asset("assets/act_m_hirata2/act_m_hirata_pal.bin", act_m_hirata_pal, 0x20, 0xB4C268, 0, 1);
    pc_load_asset("assets/act_m_hirata2/act_m_hirata.bin", act_m_hirata, 0x200, 0xB4C288, 0, 0);
}
#endif
