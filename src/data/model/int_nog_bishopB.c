...
#ifdef TARGET_PC
u16 int_nog_bishopB_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u8 int_nog_bishopB_base_tex[0x200];
#else
...
#ifdef TARGET_PC
u8 int_nog_bishopB_circle_tex[0x80];
#else
...
#ifdef TARGET_PC
u8 int_nog_bishopB_crown_tex[0x200];
#else
...
#ifdef TARGET_PC
Vtx int_nog_bishopB_v[0x2A0 / sizeof(Vtx)];
#else
