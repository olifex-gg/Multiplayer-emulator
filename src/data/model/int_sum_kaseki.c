...
#ifdef TARGET_PC
u16 int_sum_kaseki_glass_pic_ci4_pal[0x20 / sizeof(u16)];
#else
...
#ifdef TARGET_PC
u8 int_sum_kaseki_body_txt[0x400];
#else
...
#ifdef TARGET_PC
u8 int_sum_kaseki_side_txt[0x200];
#else
...
#ifdef TARGET_PC
u8 int_sum_kaseki_base_txt[0x80];
#else
...
#ifdef TARGET_PC
u8 int_sum_kaseki_top_txt[0x100];
#else
...
#ifdef TARGET_PC
u8 int_sum_kaseki_glass_txt[0x80];
#else
...
#ifdef TARGET_PC
Vtx int_sum_kaseki_v[0x2D0 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_model_int_sum_kaseki_c(void) {
    pc_load_asset("assets/int_sum_kaseki/int_sum_kaseki_pal.bin", int_sum_kaseki_pal, 0x20, 0xCE9AC0, 0, 1);
}
#endif
