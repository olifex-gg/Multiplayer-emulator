...
#ifdef TARGET_PC
u16 obj_art_fel_etc_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u16 obj_art_fel_art_pal[0x20 / sizeof(u16)];
#else
...
#ifdef TARGET_PC
Vtx obj_art07_v[0x1E0 / sizeof(Vtx)];
#else
Vtx obj_art07_v[] = {
