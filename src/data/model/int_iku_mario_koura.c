...
#ifdef TARGET_PC
u16 int_iku_mario_koura_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u8 int_iku_mario_koura_a_tex_txt[0x400];
#else
...
#ifdef TARGET_PC
u8 int_iku_mario_koura_b_tex_txt[0x400];
#else
...
#ifdef TARGET_PC
Vtx int_iku_mario_koura_v[0x2E0 / sizeof(Vtx)];
#else
