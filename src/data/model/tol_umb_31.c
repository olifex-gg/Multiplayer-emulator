...
#ifdef TARGET_PC
u16 tol_umb_31_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u8 tol_umb_31_kasa_tex_txt[0x200];
#else
...
#ifdef TARGET_PC
u8 tol_umb_31_tuka_tex_txt[0x200];
#else
...
#ifdef TARGET_PC
Vtx tol_umb_31_v[0x360 / sizeof(Vtx)];
#else
Vtx tol_umb_31_v[] = {
