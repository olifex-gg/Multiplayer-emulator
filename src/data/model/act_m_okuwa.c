...
void _pc_load_src_data_model_act_m_okuwa_c(void) {
    pc_load_asset("assets/act_m_okuwa/act_m_okuwa_pal.bin", act_m_okuwa_pal, 0x20, 0x546840, 0, 1);
    pc_load_asset("assets/act_m_okuwa/act_m_okuwa.bin", act_m_okuwa, 0x200, 0x546860, 0, 0);
    pc_load_asset("assets/act_m_okuwa/act_m_okuwa_v.bin", act_m_okuwa_v, 0xC0, 0x546A60, 0, 2);
}
#endif
