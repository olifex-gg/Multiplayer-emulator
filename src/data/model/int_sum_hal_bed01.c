...
#ifdef TARGET_PC
u16 int_sum_hal_bed01_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u8 int_sum_hal_bed01_head_tex[0x200];
#else
...
#ifdef TARGET_PC
u8 int_sum_hal_bed01_top_tex[0x200];
#else
...
#ifdef TARGET_PC
u8 int_sum_hal_bed01_side_tex[0x80];
#else
...
#ifdef TARGET_PC
u8 int_sum_hal_bed01_pillow_tex[0x80];
#else
...
#ifdef TARGET_PC
u8 int_sum_hal_bed01_kuki_tex[0x80];
#else
...
#ifdef TARGET_PC
u8 int_sum_hal_bed01_foot_tex[0x80];
#else
...
#ifdef TARGET_PC
Vtx int_sum_hal_bed01_v[0x4A0 / sizeof(Vtx)];
#else
