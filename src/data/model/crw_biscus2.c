...
#ifdef TARGET_PC
u16 crw_biscus2_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
Vtx crw_biscus2_v[0x390 / sizeof(Vtx)];
#else
Vtx crw_biscus2_v[] = {
