...
#ifdef TARGET_PC
static u16 act_m_tonosama_pal[0x20 / sizeof(u16)];
#else
...
void _pc_load_src_data_model_act_m_tonosama2_c(void) {
    pc_load_asset("assets/act_m_tonosama2/act_m_tonosama_v.bin", act_m_tonosama_v, 0x120, 0xB56500, 0, 2);
    pc_load_asset("assets/act_m_tonosama2/act_m_tonosama_pal.bin", act_m_tonosama_pal, 0x20, 0xB56620, 0, 1);
    pc_load_asset("assets/act_m_tonosama2/act_m_tonosama.bin", act_m_tonosama, 0x200, 0xB56640, 0, 0);
}
#endif
