...
#ifdef TARGET_PC
u16 obj_shop_honegai_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u8 obj_shop_honegai_tex[0xC0] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
Vtx obj_shop_honegai_v[0x70 / sizeof(Vtx)];
#else
