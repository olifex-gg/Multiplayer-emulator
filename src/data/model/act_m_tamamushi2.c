...
#ifdef TARGET_PC
static u16 act_m_tamamushi_pal[0x20 / sizeof(u16)];
#else
...
void _pc_load_src_data_model_act_m_tamamushi2_c(void) {
    pc_load_asset("assets/act_m_tamamushi2/act_m_tamamushi_v.bin", act_m_tamamushi_v, 0xC0, 0xB55C78, 0, 2);
    pc_load_asset("assets/act_m_tamamushi2/act_m_tamamushi_pal.bin", act_m_tamamushi_pal, 0x20, 0xB55D38, 0, 1);
    pc_load_asset("assets/act_m_tamamushi2/act_m_tamamushi.bin", act_m_tamamushi, 0x200, 0xB55D58, 0, 0);
}
#endif
