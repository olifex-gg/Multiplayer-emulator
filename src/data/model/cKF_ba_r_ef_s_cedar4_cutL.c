...
u8 cKF_ckcb_r_ef_s_cedar4_cutL_tbl[] = { 0, 7, 7, 3 };

s16 cKF_kn_ef_s_cedar4_cutL_tbl[] = { 8, 12, 10, 10, 12, 10, 4, 20 };

s16 cKF_c_ef_s_cedar4_cutL_tbl[] = { -750, 0, 0, 0, 0, 900, 0 };
...
cKF_Animation_R_c cKF_ba_r_ef_s_cedar4_cutL = { cKF_ckcb_r_ef_s_cedar4_cutL_tbl,
                                                cKF_ds_ef_s_cedar4_cutL_tbl,
                                                cKF_kn_ef_s_cedar4_cutL_tbl,
                                                cKF_c_ef_s_cedar4_cutL_tbl,
                                                -1,
                                                49 };
