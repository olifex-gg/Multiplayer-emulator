...
void _pc_load_src_data_model_obj_shop_kaza5_c(void) {
    pc_load_asset("assets/obj_shop_kaza5/tol_kaza_5_pal.bin", tol_kaza_5_pal, 0x20, 0x45FE40, 0, 1);
    pc_load_asset("assets/obj_shop_kaza5/tol_kaza_5_a_tex_txt.bin", tol_kaza_5_a_tex_txt, 0x200, 0x45FE60, 0, 0);
    pc_load_asset("assets/obj_shop_kaza5/tol_kaza_5_c_tex_txt.bin", tol_kaza_5_c_tex_txt, 0x200, 0x460060, 0, 0);
    pc_load_asset("assets/obj_shop_kaza5/tol_kaza_5_b_tex_txt.bin", tol_kaza_5_b_tex_txt, 0x100, 0x460260, 0, 0);
}
#endif
