...
#ifdef TARGET_PC
u16 act_f18_ayu_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u8 act_f18_ayu_tex[0x300] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
Vtx act_f18_ayu_a_v[0x90 / sizeof(Vtx)];
#else
Vtx act_f18_ayu_a_v[] = {
...
#ifdef TARGET_PC
Vtx act_f18_ayu_b_v[0x90 / sizeof(Vtx)];
#else
Vtx act_f18_ayu_b_v[] = {
...
#ifdef TARGET_PC
Vtx act_f18_ayu_c_v[0x90 / sizeof(Vtx)];
#else
Vtx act_f18_ayu_c_v[] = {
