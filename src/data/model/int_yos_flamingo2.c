...
#ifdef TARGET_PC
u16 int_yos_flamingo2_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u8 int_yos_flamingo2_kao_tex_txt[0x400];
#else
...
#ifdef TARGET_PC
u8 int_yos_flamingo2_dou_tex_txt[0x400];
#else
...
#ifdef TARGET_PC
Vtx int_yos_flamingo2_v[0x450 / sizeof(Vtx)];
#else
