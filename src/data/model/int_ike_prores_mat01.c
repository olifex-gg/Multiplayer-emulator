...
#ifdef TARGET_PC
u16 int_ike_prores_mat01_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u8 int_ike_prores_mat01_handle_tex[0x40];
#else
...
#ifdef TARGET_PC
u8 int_ike_prores_mat01_top_tex[0x100];
#else
...
#ifdef TARGET_PC
u8 int_ike_prores_mat01_side_tex[0x40];
#else
...
#ifdef TARGET_PC
Vtx int_ike_prores_mat01_v[0x240 / sizeof(Vtx)];
#else
