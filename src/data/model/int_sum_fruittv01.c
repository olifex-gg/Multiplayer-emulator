...
#ifdef TARGET_PC
u16 int_sum_fruittv01_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u8 int_sum_fruittv01_antena_tex_txt[0x100];
#else
...
#ifdef TARGET_PC
u8 int_sum_fruittv01_ha_tex_txt[0x80];
#else
...
#ifdef TARGET_PC
u8 int_sum_fruittv01_foot_tex_txt[0x80];
#else
...
#ifdef TARGET_PC
u8 int_sum_fruittv01_front_tex_txt[0x300];
#else
...
#ifdef TARGET_PC
u8 int_sum_fruittv01_body_tex_txt[0x200];
#else
...
#ifdef TARGET_PC
u8 int_sum_fruittv01_front1_TA_tex_txt[0x100];
#else
...
#ifdef TARGET_PC
u8 int_sum_fruittv01_front2_TA_tex_txt[0x100];
#else
...
#ifdef TARGET_PC
u8 int_sum_fruittv01_front3_TA_tex_txt[0x100];
#else
...
#ifdef TARGET_PC
u8 int_sum_fruittv01_front4_TA_tex_txt[0x100];
#else
...
#ifdef TARGET_PC
Vtx int_sum_fruittv01_v[0x340 / sizeof(Vtx)];
#else
