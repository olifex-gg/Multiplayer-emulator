...
#ifdef TARGET_PC
u16 int_ike_k_sinnen01_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u8 int_ike_k_osetiside_tex[0x100];
#else
...
#ifdef TARGET_PC
Vtx int_ike_k_sinnen01_v[0x280 / sizeof(Vtx)];
#else
