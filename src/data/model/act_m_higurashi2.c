...
#ifdef TARGET_PC
static u16 act_m_higurashi_pal[0x20 / sizeof(u16)];
#else
...
void _pc_load_src_data_model_act_m_higurashi2_c(void) {
    pc_load_asset("assets/act_m_higurashi2/act_m_higurashi_v.bin", act_m_higurashi_v, 0x160, 0xB4BC98, 0, 2);
    pc_load_asset("assets/act_m_higurashi2/act_m_higurashi_pal.bin", act_m_higurashi_pal, 0x20, 0xB4BDF8, 0, 1);
    pc_load_asset("assets/act_m_higurashi2/act_m_higurashi.bin", act_m_higurashi, 0x200, 0xB4BE18, 0, 0);
}
#endif
