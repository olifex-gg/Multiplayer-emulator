...
#ifdef TARGET_PC
u16 act_f16_dojyo_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u8 act_f16_dojyo_tex[0x100] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
Vtx act_f16_dojyo_a_v[0x90 / sizeof(Vtx)];
#else
...
#ifdef TARGET_PC
Vtx act_f16_dojyo_b_v[0x90 / sizeof(Vtx)];
#else
...
#ifdef TARGET_PC
Vtx act_f16_dojyo_c_v[0x90 / sizeof(Vtx)];
#else
