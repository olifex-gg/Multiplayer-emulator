...
#ifdef TARGET_PC
static u16 act_m_ka_pal[0x20 / sizeof(u16)];
#else
...
void _pc_load_src_data_model_act_m_ka2_c(void) {
    pc_load_asset("assets/act_m_ka2/act_m_ka_v.bin", act_m_ka_v, 0x180, 0xB4D150, 0, 2);
    pc_load_asset("assets/act_m_ka2/act_m_ka_pal.bin", act_m_ka_pal, 0x20, 0xB4D2D0, 0, 1);
    pc_load_asset("assets/act_m_ka2/act_m_ka_tex.bin", act_m_ka_tex, 0x180, 0xB4D2F0, 0, 0);
}
#endif
