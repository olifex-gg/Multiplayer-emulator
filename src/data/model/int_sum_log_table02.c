...
#ifdef TARGET_PC
u16 int_sum_log_table02_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u8 int_sum_log_table02_top_tex[0x400];
#else
...
#ifdef TARGET_PC
u8 int_sum_log_table02_side_tex[0x100];
#else
...
#ifdef TARGET_PC
u8 int_sum_log_table02_stand_tex[0x100];
#else
...
#ifdef TARGET_PC
Vtx int_sum_log_table02_v[0x3E0 / sizeof(Vtx)];
#else
