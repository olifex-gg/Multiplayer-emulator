...
#ifdef TARGET_PC
u16 int_sum_blue_table01_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u8 int_sum_blue_table01_top_tex[0x200];
#else
...
#ifdef TARGET_PC
u8 int_sum_blue_table01_side_tex[0x100];
#else
...
#ifdef TARGET_PC
u8 int_sum_blue_table01_foot_tex[0x100];
#else
...
#ifdef TARGET_PC
Vtx int_sum_blue_table01_v[0x340 / sizeof(Vtx)];
#else
