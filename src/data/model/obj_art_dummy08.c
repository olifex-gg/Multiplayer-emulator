...
#ifdef TARGET_PC
u16 obj_art_dummy08_pal[0x20 / sizeof(u16)];
#else
...
#ifdef TARGET_PC
u8 obj_art_dummy08_back_tex[0x300];
#else
...
#ifdef TARGET_PC
u8 obj_art_dummy08_name_tex[0x80];
#else
...
#ifdef TARGET_PC
Vtx obj_art_dummy08_v[0x1E0 / sizeof(Vtx)];
#else
