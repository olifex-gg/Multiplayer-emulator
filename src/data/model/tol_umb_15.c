...
#ifdef TARGET_PC
u16 tol_umb_15_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u8 tol_umb_15_kasa1_tex_txt[0x100];
#else
...
#ifdef TARGET_PC
u8 tol_umb_15_kasa2_tex_txt[0x200];
#else
...
#ifdef TARGET_PC
u8 tol_umb_15_tuka_tex_txt[0x200];
#else
...
#ifdef TARGET_PC
Vtx tol_umb_15_v[0x3C0 / sizeof(Vtx)];
#else
Vtx tol_umb_15_v[] = {
