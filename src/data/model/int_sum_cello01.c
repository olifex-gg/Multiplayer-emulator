...
#ifdef TARGET_PC
u16 int_sum_cello01_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u8 int_sum_cello01_front_tex[0x300];
#else
...
#ifdef TARGET_PC
u8 int_sum_cello01_back_tex[0x180];
#else
...
#ifdef TARGET_PC
u8 int_sum_cello01_side_tex[0x80];
#else
...
#ifdef TARGET_PC
u8 int_sum_cello01_neck_tex[0x100];
#else
...
#ifdef TARGET_PC
u8 int_sum_cello01_neckback_tex[0x80];
#else
...
#ifdef TARGET_PC
u8 int_sum_cello01_hand_tex[0x80];
#else
...
#ifdef TARGET_PC
u8 int_sum_cello01_stand_tex[0x100];
#else
...
#ifdef TARGET_PC
Vtx int_sum_cello01_v[0x390 / sizeof(Vtx)];
#else
