...
#ifdef TARGET_PC
u16 int_nog_balloon7_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u8 int_nog_balloon7_weight_tex_txt[0x100];
#else
...
#ifdef TARGET_PC
u8 int_nog_balloon75_head_tex_rgb_ia8[0x400];
#else
...
#ifdef TARGET_PC
Vtx int_nog_balloon7_v[0xE20 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_model_int_nog_balloon7_c(void) {
    pc_load_asset("assets/int_nog_balloon7/tol_balloon1_wire_tex_txt.bin", tol_balloon1_wire_tex_txt, 0x80, 0xBCBD80, 0, 0);
}
#endif
