...
#ifdef TARGET_PC
u16 obj_shop_sango_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u8 obj_shop_sango_tex[0x200] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
Vtx obj_shop_sango_v[0x80 / sizeof(Vtx)];
#else
