...
#ifdef TARGET_PC
static Vtx rcc_1_v[0x15B0 / sizeof(Vtx)];
#else
static Vtx rcc_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_rcc_1_c(void) {
    pc_load_asset("assets/npc/mdl/rcc_1_v.bin", rcc_1_v, 0x15B0, 0x49E468, 0, 2);
}
#endif
