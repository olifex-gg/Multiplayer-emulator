...
#ifdef TARGET_PC
static Vtx rcf_1_v[0x1B30 / sizeof(Vtx)];
#else
static Vtx rcf_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_rcf_1_c(void) {
    pc_load_asset("assets/npc/mdl/rcf_1_v.bin", rcf_1_v, 0x1B30, 0x4F8140, 0, 2);
}
#endif
