...
#ifdef TARGET_PC
static Vtx crd_1_v[0x1790 / sizeof(Vtx)];
#else
static Vtx crd_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_crd_1_c(void) {
    pc_load_asset("assets/npc/mdl/crd_1_v.bin", crd_1_v, 0x1790, 0x4A7BA0, 0, 2);
}
#endif
