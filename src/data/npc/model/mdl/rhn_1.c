...
#ifdef TARGET_PC
static Vtx rhn_1_v[0x1C00 / sizeof(Vtx)];
#else
static Vtx rhn_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_rhn_1_c(void) {
    pc_load_asset("assets/npc/mdl/rhn_1_v.bin", rhn_1_v, 0x1C00, 0x64A180, 0, 2);
}
#endif
