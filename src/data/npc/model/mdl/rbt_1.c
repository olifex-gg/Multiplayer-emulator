...
#ifdef TARGET_PC
static Vtx rbt_1_v[0x15A0 / sizeof(Vtx)];
#else
static Vtx rbt_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_rbt_1_c(void) {
    pc_load_asset("assets/npc/mdl/rbt_1_v.bin", rbt_1_v, 0x15A0, 0x638760, 0, 2);
}
#endif
