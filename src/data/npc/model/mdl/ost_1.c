...
#ifdef TARGET_PC
static Vtx ost_1_v[0x17D0 / sizeof(Vtx)];
#else
static Vtx ost_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_ost_1_c(void) {
    pc_load_asset("assets/npc/mdl/ost_1_v.bin", ost_1_v, 0x17D0, 0x60ACC0, 0, 2);
}
#endif
