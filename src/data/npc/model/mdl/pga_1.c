...
#ifdef TARGET_PC
static Vtx pga_1_v[0x1A20 / sizeof(Vtx)];
#else
static Vtx pga_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_pga_1_c(void) {
    pc_load_asset("assets/npc/mdl/pga_1_v.bin", pga_1_v, 0x1A20, 0x62EAE0, 0, 2);
}
#endif
