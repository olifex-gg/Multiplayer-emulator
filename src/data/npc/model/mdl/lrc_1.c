...
#ifdef TARGET_PC
static Vtx lrc_1_v[0x1540 / sizeof(Vtx)];
#else
static Vtx lrc_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_lrc_1_c(void) {
    pc_load_asset("assets/npc/mdl/lrc_1_v.bin", lrc_1_v, 0x1540, 0x580EA0, 0, 2);
}
#endif
