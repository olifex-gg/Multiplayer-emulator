...
#ifdef TARGET_PC
static Vtx pgb_1_v[0x1990 / sizeof(Vtx)];
#else
static Vtx pgb_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_pgb_1_c(void) {
    pc_load_asset("assets/npc/mdl/pgb_1_v.bin", pgb_1_v, 0x1990, 0x631E40, 0, 2);
}
#endif
