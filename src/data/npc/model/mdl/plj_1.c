...
#ifdef TARGET_PC
static Vtx plj_1_v[0x16A0 / sizeof(Vtx)];
#else
static Vtx plj_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_plj_1_c(void) {
    pc_load_asset("assets/npc/mdl/plj_1_v.bin", plj_1_v, 0x16A0, 0x548B40, 0, 2);
}
#endif
