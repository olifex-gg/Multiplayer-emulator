...
#ifdef TARGET_PC
static Vtx fox_1_v[0x1700 / sizeof(Vtx)];
#else
static Vtx fox_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_fox_1_c(void) {
    pc_load_asset("assets/npc/mdl/fox_1_v.bin", fox_1_v, 0x1700, 0x465E28, 0, 2);
}
#endif
