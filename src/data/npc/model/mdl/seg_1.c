...
#ifdef TARGET_PC
static Vtx seg_1_v[0x1860 / sizeof(Vtx)];
#else
static Vtx seg_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_seg_1_c(void) {
    pc_load_asset("assets/npc/mdl/seg_1_v.bin", seg_1_v, 0x1860, 0x4C3DC0, 0, 2);
}
#endif
