...
#ifdef TARGET_PC
static Vtx owl_1_v[0x1A90 / sizeof(Vtx)];
#else
static Vtx owl_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_owl_1_c(void) {
    pc_load_asset("assets/npc/mdl/owl_1_v.bin", owl_1_v, 0x1A90, 0x4AD1C0, 0, 2);
}
#endif
