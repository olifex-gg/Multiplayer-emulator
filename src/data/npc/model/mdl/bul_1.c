...
#ifdef TARGET_PC
static Vtx bul_1_v[0x1680 / sizeof(Vtx)];
#else
static Vtx bul_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_bul_1_c(void) {
    pc_load_asset("assets/npc/mdl/bul_1_v.bin", bul_1_v, 0x1680, 0x468E00, 0, 2);
}
#endif
