...
#ifdef TARGET_PC
static Vtx snt_1_v[0x13C0 / sizeof(Vtx)];
#else
static Vtx snt_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_snt_1_c(void) {
    pc_load_asset("assets/npc/mdl/snt_1_v.bin", snt_1_v, 0x13C0, 0x658F88, 0, 2);
}
#endif
