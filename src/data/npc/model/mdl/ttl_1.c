...
#ifdef TARGET_PC
static Vtx ttl_1_v[0x1450 / sizeof(Vtx)];
#else
static Vtx ttl_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_ttl_1_c(void) {
    pc_load_asset("assets/npc/mdl/ttl_1_v.bin", ttl_1_v, 0x1450, 0x7C8E00, 0, 2);
}
#endif
