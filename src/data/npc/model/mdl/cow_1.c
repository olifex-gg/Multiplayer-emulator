...
#ifdef TARGET_PC
static Vtx cow_1_v[0x1630 / sizeof(Vtx)];
#else
static Vtx cow_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_cow_1_c(void) {
    pc_load_asset("assets/npc/mdl/cow_1_v.bin", cow_1_v, 0x1630, 0x4A1340, 0, 2);
}
#endif
