...
#ifdef TARGET_PC
static Vtx pig_1_v[0x13F0 / sizeof(Vtx)];
#else
static Vtx pig_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_pig_1_c(void) {
    pc_load_asset("assets/npc/mdl/pig_1_v.bin", pig_1_v, 0x13F0, 0x619C80, 0, 2);
}
#endif
