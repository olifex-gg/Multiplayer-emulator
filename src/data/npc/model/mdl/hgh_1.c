...
#ifdef TARGET_PC
static Vtx hgh_1_v[0x1CA0 / sizeof(Vtx)];
#else
static Vtx hgh_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_hgh_1_c(void) {
    pc_load_asset("assets/npc/mdl/hgh_1_v.bin", hgh_1_v, 0x1CA0, 0x5A1CB0, 0, 2);
}
#endif
