...
#ifdef TARGET_PC
static Vtx pla_1_v[0x1CB0 / sizeof(Vtx)];
#else
static Vtx pla_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_pla_1_c(void) {
    pc_load_asset("assets/npc/mdl/pla_1_v.bin", pla_1_v, 0x1CB0, 0x627AE0, 0, 2);
}
#endif
