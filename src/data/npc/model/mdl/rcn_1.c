...
#ifdef TARGET_PC
static Vtx rcn_1_v[0x1650 / sizeof(Vtx)];
#else
static Vtx rcn_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_rcn_1_c(void) {
    pc_load_asset("assets/npc/mdl/rcn_1_v.bin", rcn_1_v, 0x1650, 0x667CA0, 0, 2);
}
#endif
