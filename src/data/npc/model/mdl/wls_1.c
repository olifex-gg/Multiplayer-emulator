...
#ifdef TARGET_PC
static Vtx wls_1_v[0x1A50 / sizeof(Vtx)];
#else
static Vtx wls_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_wls_1_c(void) {
    pc_load_asset("assets/npc/mdl/wls_1_v.bin", wls_1_v, 0x1A50, 0x379900, 0, 2);
}
#endif
