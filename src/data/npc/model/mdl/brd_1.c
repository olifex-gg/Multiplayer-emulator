...
#ifdef TARGET_PC
static Vtx brd_1_v[0x1600 / sizeof(Vtx)];
#else
static Vtx brd_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_brd_1_c(void) {
    pc_load_asset("assets/npc/mdl/brd_1_v.bin", brd_1_v, 0x1600, 0x404160, 0, 2);
}
#endif
