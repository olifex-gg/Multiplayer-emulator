...
#ifdef TARGET_PC
static Vtx hgs_1_v[0x1C80 / sizeof(Vtx)];
#else
static Vtx hgs_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_hgs_1_c(void) {
    pc_load_asset("assets/npc/mdl/hgs_1_v.bin", hgs_1_v, 0x1C80, 0x5A5340, 0, 2);
}
#endif
