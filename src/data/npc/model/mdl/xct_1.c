...
#ifdef TARGET_PC
static Vtx xct_1_v[0x13B0 / sizeof(Vtx)];
#else
static Vtx xct_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_xct_1_c(void) {
    pc_load_asset("assets/npc/mdl/xct_1_v.bin", xct_1_v, 0x13B0, 0x512240, 0, 2);
}
#endif
