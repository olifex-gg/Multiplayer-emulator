...
#ifdef TARGET_PC
static Vtx plc_1_v[0x1730 / sizeof(Vtx)];
#else
static Vtx plc_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_plc_1_c(void) {
    pc_load_asset("assets/npc/mdl/plc_1_v.bin", plc_1_v, 0x1730, 0x62A158, 0, 2);
}
#endif
