...
#ifdef TARGET_PC
static Vtx bpt_1_v[0x16E0 / sizeof(Vtx)];
#else
static Vtx bpt_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_bpt_1_c(void) {
    pc_load_asset("assets/npc/mdl/bpt_1_v.bin", bpt_1_v, 0x16E0, 0x524768, 0, 2);
}
#endif
