...
#ifdef TARGET_PC
static Vtx kgr_1_v[0x1AF0 / sizeof(Vtx)];
#else
static Vtx kgr_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_kgr_1_c(void) {
    pc_load_asset("assets/npc/mdl/kgr_1_v.bin", kgr_1_v, 0x1AF0, 0x55BB80, 0, 2);
}
#endif
