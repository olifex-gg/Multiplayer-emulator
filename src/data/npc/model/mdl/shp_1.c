...
#ifdef TARGET_PC
static Vtx shp_1_v[0x1460 / sizeof(Vtx)];
#else
static Vtx shp_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_shp_1_c(void) {
    pc_load_asset("assets/npc/mdl/shp_1_v.bin", shp_1_v, 0x1460, 0x65F3A0, 0, 2);
}
#endif
