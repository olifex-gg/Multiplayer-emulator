...
#ifdef TARGET_PC
static Vtx cat_1_v[0x1430 / sizeof(Vtx)];
#else
static Vtx cat_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_cat_1_c(void) {
    pc_load_asset("assets/npc/mdl/cat_1_v.bin", cat_1_v, 0x1430, 0x472CA0, 0, 2);
}
#endif
