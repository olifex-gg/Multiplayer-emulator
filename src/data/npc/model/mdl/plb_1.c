...
#ifdef TARGET_PC
static Vtx plb_1_v[0x1A80 / sizeof(Vtx)];
#else
static Vtx plb_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_plb_1_c(void) {
    pc_load_asset("assets/npc/mdl/plb_1_v.bin", plb_1_v, 0x1A80, 0x635240, 0, 2);
}
#endif
