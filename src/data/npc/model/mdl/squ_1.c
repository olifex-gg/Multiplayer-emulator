...
#ifdef TARGET_PC
static Vtx squ_1_v[0x16F0 / sizeof(Vtx)];
#else
static Vtx squ_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_squ_1_c(void) {
    pc_load_asset("assets/npc/mdl/squ_1_v.bin", squ_1_v, 0x16F0, 0x7CBB80, 0, 2);
}
#endif
