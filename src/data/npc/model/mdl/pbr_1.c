...
#ifdef TARGET_PC
static Vtx pbr_1_v[0x1740 / sizeof(Vtx)];
#else
static Vtx pbr_1_v[] = {
...
void _pc_load_src_data_npc_model_mdl_pbr_1_c(void) {
    pc_load_asset("assets/npc/mdl/pbr_1_v.bin", pbr_1_v, 0x1740, 0x3FDDE8, 0, 2);
}
#endif
